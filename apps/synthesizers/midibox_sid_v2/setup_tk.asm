...
#define DEFAULT_SRM_MODMATRIX_DOUT	3
...
CS_MENU_DIN_TABLE
	DIN_ENTRY	CS_MENU_BUTTON_Sel1,	 16+8,	 0
	DIN_ENTRY	CS_MENU_BUTTON_Sel2,	 16+8,	 1
	DIN_ENTRY	CS_MENU_BUTTON_Sel3,	 16+8,	 2
	DIN_ENTRY	CS_MENU_BUTTON_Sel4,	 16+8,	 3
	DIN_ENTRY	CS_MENU_BUTTON_Sel5,	 16+8,	 4
	DIN_ENTRY	CS_MENU_BUTTON_Exec,	 16+8,	 7

	DIN_ENTRY	CS_MENU_BUTTON_SID1,	 16+7,	 0
	DIN_ENTRY	CS_MENU_BUTTON_SID2,	 16+7,	 1
	DIN_ENTRY	CS_MENU_BUTTON_SID3,	 16+7,	 2
	DIN_ENTRY	CS_MENU_BUTTON_SID4,	 16+7,	 3
	DIN_ENTRY	CS_MENU_BUTTON_Shift,	 16+7,	 4	; was: link button
	DIN_ENTRY	CS_MENU_BUTTON_CC_PageUp, 16+7,	 5	; combined CC/PageUp -- CC actived together with shift button (no error)
	DIN_ENTRY	CS_MENU_BUTTON_Edit_PageDown, 16+7, 6	; combined Edit/PageDown -- Edit actived together with shift button (no error)

	DIN_ENTRY	CS_MENU_BUTTON_Osc_Sel,	 16+1,	 0
	DIN_ENTRY	CS_MENU_BUTTON_Osc_Ctrl, 16+1,	 1
	DIN_ENTRY	CS_MENU_BUTTON_Osc_Wav,  16+1,	 2
	DIN_ENTRY	CS_MENU_BUTTON_Osc_RS,   16+1,	 3

 	DIN_ENTRY	CS_MENU_BUTTON_Fil_Sel,	 16+3,	 0
	DIN_ENTRY	CS_MENU_BUTTON_Fil_Mod,  16+3,	 1

 	DIN_ENTRY	CS_MENU_BUTTON_LFO_Sel,	 16+1,	 4
	DIN_ENTRY	CS_MENU_BUTTON_LFO_Wav,	 16+1,	 5

	DIN_ENTRY	CS_MENU_BUTTON_Env_Sel,	 16+3,	 6
	DIN_ENTRY	CS_MENU_BUTTON_Env_Ctrl, 16+3,	 7

	DIN_ENTRY	CS_MENU_BUTTON_M_O1Ptch, 16+6,	 0
	DIN_ENTRY	CS_MENU_BUTTON_M_O2Ptch, 16+6,	 1
	DIN_ENTRY	CS_MENU_BUTTON_M_O3Ptch, 16+6,	 2
	DIN_ENTRY	CS_MENU_BUTTON_M_O1PW,   16+6,	 3
	DIN_ENTRY	CS_MENU_BUTTON_M_O2PW,   16+6,	 4
	DIN_ENTRY	CS_MENU_BUTTON_M_O3PW,   16+6,	 5
	DIN_ENTRY	CS_MENU_BUTTON_M_Filter, 16+6,	 6
	DIN_ENTRY	CS_MENU_BUTTON_M_E1,	 16+5,	 0
	DIN_ENTRY	CS_MENU_BUTTON_M_E2,	 16+5,	 1
	DIN_ENTRY	CS_MENU_BUTTON_M_L1,	 16+5,	 2
	DIN_ENTRY	CS_MENU_BUTTON_M_L2,	 16+5,	 3
	DIN_ENTRY	CS_MENU_BUTTON_M_L3,	 16+5,	 4
	DIN_ENTRY	CS_MENU_BUTTON_M_L4,	 16+5,	 5
	DIN_ENTRY	CS_MENU_BUTTON_M_L5,	 16+5,	 6
	DIN_ENTRY	CS_MENU_BUTTON_M_L6,	 16+5,	 7
...
CS_MENU_DOUT_TABLE
	...
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 0,		16+7,	0	; SID1 LED
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 1,		16+7,	1	; SID2 LED
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 2,		16+7,	2	; SID3 LED
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 3,		16+7,	3	; SID4 LED

	DOUT_ENTRY	CS_MENU_MODE, 0,			16+7,	4	; Shift LED
	DOUT_ENTRY	CS_MENU_MODE, 1,			16+7,	5	; CC LED
	DOUT_ENTRY	CS_MENU_MODE, 4,			16+7,	6	; Edit LED

	DOUT_ENTRY	CS_MENU_SELECTED_OSC_FLAGS, 0,		16+1,	0	; OSC1 LED
	DOUT_ENTRY	CS_MENU_SELECTED_OSC_FLAGS, 1,		16+1,	1	; OSC2 LED
	DOUT_ENTRY	CS_MENU_SELECTED_OSC_FLAGS, 2,		16+1,	2	; OSC3 LED

	DOUT_ENTRY	TMP1, 0,				16+1,	4	; OSC Env LED
	DOUT_ENTRY	TMP1, 1,				16+1,	5	; OSC Misc LED
	DOUT_ENTRY	TMP1, 2,				16+1,	6	; OSC Assign LED

	DOUT_ENTRY	TMP1, 4,				16+2,	0	; OSC Triangle LED
	DOUT_ENTRY	TMP1, 5,				16+2,	1	; OSC Saw LED
	DOUT_ENTRY	TMP1, 6,				16+2,	2	; OSC Pulse LED
	DOUT_ENTRY	TMP1, 7,				16+2,	3	; OSC Noise LED

	DOUT_ENTRY	TMP2, 0,				16+2,	4	; OSC Sync LED
	DOUT_ENTRY	TMP2, 1,				16+2,	5	; OSC Ring LED

	DOUT_ENTRY	TMP3, 0,				16+3,	0	; Filter O1 LED
	DOUT_ENTRY	TMP3, 1,				16+3,	1	; Filter O2 LED
	DOUT_ENTRY	TMP3, 2,				16+3,	2	; Filter O3 LED
	DOUT_ENTRY	TMP3, 3,				16+3,	3	; Filter Ext LED

	DOUT_ENTRY	TMP3, 4,				16+3,	4	; Filter LP LED
	DOUT_ENTRY	TMP3, 5,				16+3,	5	; Filter BP LED
	DOUT_ENTRY	TMP3, 6,				16+3,	6	; Filter HP LED
	DOUT_ENTRY	TMP3, 7,				16+3,	7	; Filter 3O LED

	DOUT_ENTRY	TMP2, 4,				16+4,	0	; ENV1 LED
	DOUT_ENTRY	TMP2, 5,				16+4,	1	; ENV2 LED
	
	DOUT_ENTRY	TMP2, 6,				16+4,	4	; ENV Ctrl LED
	DOUT_ENTRY	TMP2, 7,				16+4,	5	; ENV Assign LED

	DOUT_ENTRY	TMP4, 0,				16+5,	0	; LFO1 LED
	DOUT_ENTRY	TMP4, 1,				16+5,	1	; LFO2 LED
	DOUT_ENTRY	TMP4, 2,				16+5,	2	; LFO3 LED
	DOUT_ENTRY	TMP4, 3,				16+5,	3	; LFO4 LED
	DOUT_ENTRY	TMP4, 4,				16+5,	4	; LFO5 LED
	DOUT_ENTRY	TMP4, 5,				16+5,	5	; LFO6 LED

	DOUT_ENTRY	TMP5, 0,				16+6,	0	; LFO Sine LED
	DOUT_ENTRY	TMP5, 1,				16+6,	1	; LFO Triangle LED
	DOUT_ENTRY	TMP5, 2,				16+6,	2	; LFO Saw LED
	DOUT_ENTRY	TMP5, 3,				16+6,	3	; LFO Pulse LED
	DOUT_ENTRY	TMP5, 4,				16+6,	4	; LFO Random LED
...
;;    ENC_ENTRY  1,  2,  MIOS_ENC_MODE_DETENTED1       ; detented encoder at pin 2 and 3 of SR 1
...
MIOS_ENC_PIN_TABLE
	...
	;;        SR  Pin  Mode
	ENC_ENTRY  1,  2,  MIOS_ENC_MODE_DETENTED2	; Osc delay/transpose/assign #1
	ENC_ENTRY  1,  4,  MIOS_ENC_MODE_DETENTED2	; Osc attack/finetune/assign #2
	ENC_ENTRY  1,  6,  MIOS_ENC_MODE_DETENTED2	; Osc decay/portamento/assign #3

	ENC_ENTRY  2,  0,  MIOS_ENC_MODE_DETENTED2	; Osc sustain/release/assign #4
	ENC_ENTRY  2,  2,  MIOS_ENC_MODE_DETENTED2	; Osc release/pulsewidth/assign #5
	ENC_ENTRY  2,  4,  MIOS_ENC_MODE_DETENTED2	; LFO rate
	ENC_ENTRY  2,  6,  MIOS_ENC_MODE_DETENTED2	; LFO depth

	ENC_ENTRY  3,  0,  MIOS_ENC_MODE_DETENTED2	; Filter CutOff
	ENC_ENTRY  3,  2,  MIOS_ENC_MODE_DETENTED2	; Filter Resonance
	ENC_ENTRY  3,  4,  MIOS_ENC_MODE_DETENTED2	; Env depth/assign #1
	ENC_ENTRY  3,  6,  MIOS_ENC_MODE_DETENTED2	; Env attack/assign #2

	ENC_ENTRY  4,  0,  MIOS_ENC_MODE_DETENTED2	; Env decay/assign #3
	ENC_ENTRY  4,  2,  MIOS_ENC_MODE_DETENTED2	; Env sustain/assign #4
	ENC_ENTRY  4,  4,  MIOS_ENC_MODE_DETENTED2	; Env release/assign #5
