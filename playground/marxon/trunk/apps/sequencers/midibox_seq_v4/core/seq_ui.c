// $Id: seq_ui.c 2027 2014-08-03 19:38:00Z tk $
/*
...
s32 SEQ_UI_LED_Handler(void)
{
  ...
  if( seq_ui_button_state.MENU_PRESSED ) {
	...
	SEQ_LED_PinSet(seq_hwcfg_led.rew, seq_ui_button_state.COPY);
	SEQ_LED_PinSet(seq_hwcfg_led.fwd, seq_ui_button_state.PASTE);
